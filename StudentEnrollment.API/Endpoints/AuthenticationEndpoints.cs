...
namespace StudentEnrollment.API.Endpoints
{
    public static class AuthenticationEndpoints
    {
        ...
        {
            routes.MapPost("/api/login", async (LoginDto loginDto, IAuthManager authManager, IValidator<LoginDto> loginDtoValidator) =>
            {
            ...
            routes.MapPost("/api/register", async (RegisterDto registerDto, IAuthManager authManager, IValidator<LoginDto> loginDtoValidator) =>
            {
                var validationResult = await loginDtoValidator.ValidateAsync(loginDto);
